          ...
          <div className="card hero-panel" style={{ marginBottom: 'var(--space-lg)' }}>
            ...
            <div className="hero-body">
              ...
              <div className="hero-actions">
                ...
                <button className="btn btn-outline" type="button">View Schedule</button>
              </div>
            </div>
            ...
            <div className="card" style={{ textAlign: 'center' }}>
              ...
              <div className="chart-legend">
                <div className="chart-legend-item">
                  <span className="swatch-label"><span className="swatch accent"></span>Ready</span>
                  <span>70%</span>
                </div>
                <div className="chart-legend-item">
                  <span className="swatch-label"><span className="swatch primary"></span>In Progress</span>
                  <span>20%</span>
                </div>
                <div className="chart-legend-item">
                  <span className="swatch-label"><span className="swatch muted"></span>Not Started</span>
                  <span>10%</span>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="line-chart-wrapper">
                <svg className="line-chart" viewBox="0 0 420 150" preserveAspectRatio="none">
                  <line className="line-chart-grid" x1="0" y1="30" x2="420" y2="30" />
                  <line className="line-chart-grid" x1="0" y1="65" x2="420" y2="65" />
                  <line className="line-chart-grid" x1="0" y1="100" x2="420" y2="100" />
                  <polygon
                  ...
                  <text className="line-chart-axis" x="10" y="138">1</text>
                  <text className="line-chart-axis" x="126" y="138">2</text>
                  <text className="line-chart-axis" x="246" y="138">3</text>
                  <text className="line-chart-axis" x="362" y="138">4</text>
                </svg>
              </div>
            </div>
          </div>
